...
set(handles.slider4,'Max',H/2)
set(handles.slider4,'MIN',-H/2)
set(handles.slider5,'Max',W/2)
set(handles.slider5,'MIN',-W/2)
...
surf(handles.axes2,h), shading interp
colormap(copper)
axis ij
